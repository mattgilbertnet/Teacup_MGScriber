...
#define Y_MIN_PIN                DIO9
//#define Y_MAX_PIN                DIO26
#define Y_ENABLE_PIN             DIO5
//#define Y_INVERT_DIR
//#define Y_INVERT_MIN
//#define Y_INVERT_MAX
#define Y_INVERT_ENABLE

#define Z_STEP_PIN               DIO12
#define Z_DIR_PIN                DIO13
#define Z_MIN_PIN                DIO10
#define Z_MAX_PIN                DIO19
#define Z_ENABLE_PIN             DIO11
#define Z_INVERT_DIR
//#define Z_INVERT_MIN
//#define Z_INVERT_MAX
...
//DEFINE_TEMP_SENSOR(noheater, TT_THERMISTOR, AIO5,  THERMISTOR_NOHEATER)

// Beta algorithm      r0      beta  r2    vadc
// Steinhart-Hart      rp      t0    r0      t1    r1      t2    r2
//TEMP_TABLE NOHEATER (100000, 3974, 4700, 5.0)
